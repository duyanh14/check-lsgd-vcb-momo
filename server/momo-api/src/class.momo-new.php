...

{
    ...
    private $URLAction = array(
        ...
        'GET_USER_FRIENDS'          => 'https://owa.momo.vn/api/GET_USER_FRIENDS',
        'GET_LIST_VISITOR'          => 'https://owa.momo.vn/api/GET_LIST_VISITOR',
        'GET_USER_PROFILE'          => 'https://owa.momo.vn/api/GET_USER_PROFILE',
        'GET_SECURITY_DATA_MSG' => 'https://api.momo.vn/backend/security-center-app/api/GET_SECURITY_DATA_MSG',
        'UPLOAD_IMG'            => 'https://owa.momo.vn/api/UPLOAD_IMG',
        'APIMOMOVN_GET_TRAN'    => 'https://api.momo.vn/sync/transhis/browse',
        'APIMOMOVN_GET_COMMENT'    => 'https://api.momo.vn/sync/transhis/details',
    );
    public $configss = [
        'appVer'   => '31161',
        'appCode'  => "3.1.16",
        'token'    => "GhiSaoCungDuocDai32KyTuLaDuocNha",
    ];
    ...
    function get_RSAencrypt($public_key) {
        ...
        $requestkey = base64_encode($rsa->encrypt($this->configss['token']));
        return $requestkey;
    } 
    ...
    function request($data_curl) {
        ...
        if ($data_curl['encrypt'] == true) {
            $data_curl['data_body'] = $this->encryptDecrypt(json_encode($data_curl['data_body']), $this->configss['token'], "ENCRYPT");
        }
        ...
        if ($encrypted == true || $encrypted == "true") {
            $response = $this->encryptDecrypt($response, $this->configss['token'], "DECRYPT");
        }
    ...
    public function LoadData($phone)
    {
        ...
        $this->config['Name'] = (!empty($this->config['Name'])) ? $this->config['Name'] : $this->config['phone'];
        return $this;
    }
    ...
    public function LoginUser($password = "", $tranfer = TRUE)
    {
        ...
        $this->connect->query("UPDATE `table_momo` SET `password` = '".$this->config["password"]."',
                                                      ...
                                                      `REQUEST_ENCRYPT_KEY`  = '".trim($this->get_RSAencrypt($extra['REQUEST_ENCRYPT_KEY']))."',
    ...
    public function GetRooms($group = false)
    {
        $header = array(
            "authorization: Bearer ".$this->config["authorization"],
            "user_phone: ".$this->config["phone"],
        ...
        $result =  $this->CURL_V2("https://m.mservice.io/helios/chat-api/v1/room/get/rooms",$header,json_encode($Data));
        // return $result;
        if(empty($result['success'])){
            return array(
                'success' => false,
        ...
        $return = array();
        foreach ($result['json']['data'] as $item){
            if(empty($item['isGroup'])) continue;
            $return[] = array(
                'id'  => $item['id'],
                'users'=> $item['users']
            );
    ...
    public function SendMessVip($sdt = '')
    {
        $header = array(
            "authorization: Bearer ".$this->config["authorization"],
            "user_phone: ".$this->config["phone"],
        ...
        $Data = array (
            ...
            array (
              'source' => 'FEED',
              'cardType' => 'ENGAGEMENT_NORMAL_CARD',
              'recipient' => 
              array (
                'type' => 'USE_PARTNERS',
                'roomId' => '',
              ...
              'showText' => 'Mời bạn tham gia https://facebook.com',
              'trackingId' => $this->generateImei(),
            ),
            'templateData' => 
            array (
              'title' => 'Nhận thưởng khi tham gia ',
              'desc' => 'Cùng mình tham gia trò chơi game',
              'image' => 'https://cdn.mservice.com.vn/app/img/investment/banner_chat_referral.jpg',
              'service' => 
              array (
                'image' => 'https://atc-edge08.mservice.com.vn/momo_app_v2/new_version/Special_Force/icon_logo/ic_invest_home.png',
                'name' => 'Game Vip Nhất',
              ),
              'actionOnCard' => 
              array (
                'featureCode' => 'investment_goldenpocket',
                'params' => 
                array (
                  'refId' => 'investment_goldenpocket',
                  'referralCode' => $this->config['phone'],
                ),
              ),
              'buttonSecondary' => 
              array (
                'text' => 'Tham gia liền tay',
                'featureCode' => 'investment_goldenpocket',
                'endpoint' => '',
                'params' => 
                array (
        ...
        $Datas = array (
            ...
            array (
              ...
              'showText' => '[Lắc xì 2022] Mời bạn thăm nhà',
            ),
            'templateData' => 
            array (
              'title' => 
              array (
                'sender' => 'Mời [01636025684] so tài đoán kẹo',
                'receiver' => '[0977371507] mời bạn sang thăm nhà',
              ),
              'desc' => 'Ấy ơi, mình vừa treo túi kẹo lên cây mai. Bạn có muốn ghé nhà mình và chơi đoán kẹo hơm?',
              'image' => 'https://atc-edge02.mservice.com.vn/app/img/lx22/background_thumbnail_share_default.png',
              'actionOnCard' => NULL,
              'buttonPrimary' => 
              array (
                'sender' => 
                array (
                  'featureCode' => 'lixi_2022',
                  'params' => 
                  array (
              ...
              'briefMessage' => 
              array (
                'title' => 'Đang trả lời [0977371507]',
                'content' => 'Mời bạn thăm nhà',
              ),
            ),
        );
        ...
        $Data = array (
            ...
            array (
              'source' => 'LAC_XI',
              'trackingId' => $this->generateRandomString(10),
              'cardType' => 'LAC_XI_CARD',
              'senderId' => '0977371507',
              'recipient' => 
              array (
                'type' => 'USE_PARTNERS',
              ...
              'showText' => '[https:///facebook.com] https://facebook.com Tặng quà mới',
            ),
            'templateData' => 
            array (
              'title' => '[https:///facebook.com] https://facebook.com gửi tặng quà tết',
              'desc' => 'Truy cập https://facebook.com ngay',
              'image' => 'https://img.mservice.com.vn/app/img/lixi/ico_mh_lon_nuoc_ngot.png',
              'expiredTime' => $this->get_microtime(),
              'requestType' => NULL,
              'actionOnCard' => NULL,
              'statusCard' => 'NONE',
              'buttonSecondary' => 
              ...
              'briefMessage' => 
              array (
                'title' => 'Đang trả lời ['.$sdt.']',
                'content' => 'Tặng quà tại https://facebook.com',
              ),
            ),
        );
        
        return $this->CURL_V2('https://m.mservice.io/helios/chat-api/v1/room/send/message', $header, json_encode($Data));
    }
    ...
    public function CheckHisNew2($limit)
    {
       

        //01634506791#9223370404279312777
        $result =  $this->QUERY_TRAN_NEW();
        print_r($result);
        // return array(
        //     "status"=>"success",
        //     "message"=>"Thành công",
    ...
    public function CheckHisNew($day = 7)
    {
    ...
    public function kyc($path = [])
    {
        ...
        if(empty($result)){
            return array(
                'status' => 'error',
                'code'   => -5,
                'message'=> 'Vui lòng chờ thêm ít thời gian rồi thử lại EKYC_INIT'
            );
        }
        ...
        if(empty($result)){
            return array(
                'status' => 'error',
                'code'   => -5,
                'message'=> 'Vui lòng chờ thêm ít thời gian rồi thử lại EKYC_OCR'
            );
        }
    ...
    public function Mess($int = 0)
    {
          $header = array(
                ...
                $message = array (
                    ...
                    $message = array (
                        ...
                        array (
                            ...
                            '_id' => (string) $this->ConvertPhone($this->send['phone']),
                            'avatar' => 'https://s3-ap-southeast-1.amazonaws.com/avatars.mservice.io/'.$this->ConvertPhone($this->send['phone']).'.png',
                            ),
                        ),
                        ),
                    );
            ...
            // echo $this->HexDataMess($message); die();
            ...
            $opt = array(
                    ...
                    CURLOPT_HTTP_VERSION => CURL_VERSION_HTTPS_PROXY,
    ...
    public function link_service_tokenization()
    {
        ...
        return $this->CURL("https://owa.momo.vn/proxy/link_service_tokenization",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }
    ...
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->send['kycReference'];
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        $header = array(
            "agent_id: ".$this->config["agent_id"],
            "user_phone: ".$this->config["phone"],
    ...
    public function send()
    {
        $header = array(
            ...
            'device_os: ANDROID',
            'lang: vi',
            'authorization: Bearer -t~X6\SLmjvTSFB9}X4LsZh&Ha9vW',
            'content-type: application/json',
            'user-agent: okhttp/3.14.7'
        );
        $Data = array (
            0 => 
            array (
              'ip_address' => '149.28.146.167',
              'location' => '{"lat":18.844194,"long":105.2683022}',
              'user_id' =>  $this->config['phone'],
              'agent_id' => $this->config['agent_id'],
              'momo_session_id' => $this->config['sessionkey'],
              'momo_session_id_v2' => '',
              'user_type' => 1,
              'net_infor1' => 'VAN DAT-undefined',
              'net_infor2' => '99-192.168.1.6-255.255.255.255',
              'app_info' => 
              array (
                'id' => 'com.mservice.momotransfer',
                'version' => '3.1.2',
                'firebase_app_id' => '1:938081013731:android:1b87d137b3b464d0',
              ),
              'device' => 
              array (
                'category' => 'mobile',
                'mobile_brand_name' => 'samsung',
                'mobile_model_name' => 'SM-G532F',
                'operating_system' => 'ANDROID',
                'operating_system_version' => '23',
              ),
              'event_name' => 'my_wallet_kyc_ocr',
              'event_params' => 
              array (
                'time_take_backside' => 8527,
                'appId' => 'vn.momo.bank',
                'ip_address' => '149.28.146.167',
                'location' => '{"lat":18.844194,"long":105.2683022}',
                'user_id' => $this->config['phone'],
                ...
                'net_infor1' => 'VAN DAT-undefined',
                'net_infor2' => '99-192.168.1.6-255.255.255.255',
                'mac_address' => '24:0b:2a:07:b6:00',
              ),
              'timestamp' => $this->get_microtime(),
            ),
        );
        return $this->CURL_V2('https://m.mservice.io/apenpup-api/v1/send', $header, json_encode($Data));
    }
    ...
    public function GET_CORE_PREPAID_CARD()
    {
        ...
        $Data = array (
            ...
            'momoMsg' => 
            array (
              '_class'    => 'mservice.backend.entity.msg.PrepaidCardMsg',
              'lastUpdate'=> '1629731931898'
            ),
            'extra' => 
            array (
    ...
    public function GET_LIST_VISITOR()
    {
        ...
        $Data = array (
            ...
            'momoMsg' => 
            array (
              'targetUserId' => $this->config['phone'],
              '_class' => 'mservice.backend.entity.msg.ForwardMsg',
            ),
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_LIST_VISITOR', $microtime),
            ),
        );

        return $this->CURL("GET_LIST_VISITOR",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }

    public function GET_SECURITY_DATA_MSG()
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        ...
        $Data = array (
            ...
            'momoMsg' => 
            array (
              '_class' => 'mservice.backend.entity.msg.SecurityDataMsg',
            ),
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_SECURITY_DATA_MSG', $microtime),
            ),
        );
        return $this->CURL('GET_SECURITY_DATA_MSG', $header, $this->Encrypt_data($Data, $requestkeyRaw));
    }
    ...
    public function GET_USER_PROFILE()
    {
        ...
        $Data = array (
            ...
            'momoMsg' => 
            array (
              'sourceId' => 'vn.momo.chat;profile_info',
              'targetUserId' => $this->config['phone'],
              '_class' => 'mservice.backend.entity.msg.ForwardMsg',
            ),
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_USER_PROFILE', $microtime),
            ),
        );

        return $this->CURL("GET_USER_PROFILE",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }
    ...
    public function GET_USER_FRIENDS()
    {
        ...
        $Data = array (
            ...
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_USER_FRIENDS', $microtime),
            ),
        );

        return $this->CURL("GET_USER_FRIENDS",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }
    ...
    public function CHANGE_PIN($newpin)
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        ...
        $Data = array (
            ...
            'momoMsg' => 
            array (
              '_class' => 'mservice.backend.entity.msg.ChangePinMsg',
              'newPin' => $newpin,
              'oldPin' => $this->config['password'],
              'agentReference' => $this->config['phone'],
            ),
            'extra' => 
            array (
              'pHash' => $this->get_pHash(),
              'checkSum' => $this->generateCheckSum('CHANGE_PIN', $microtime),
            ),
        );

        return $this->CURL("CHANGE_PIN",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }

    public function TRAN_HIS_LIST()
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
    ...
    public function CREATE_MONEY_REQUEST_LINK($config)
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        ...
        $Data = array (
            'user' => $this->config['phone'],
            'msgType' => 'CREATE_MONEY_REQUEST_LINK',
            'cmdId' => (string) $microtime. '000000',
            'lang' => 'vi',
            'time' => (int) $microtime,
            'channel' => 'APP',
            ...
            array (
              ...
              'userDefinedId' => 'AEI9Tgs4UKf1C2I9spFpuP',
            ),
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('CREATE_MONEY_REQUEST_LINK', $microtime),
            ),
        );

        return $this->CURL("CREATE_MONEY_REQUEST_LINK",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }

    public function GET_MONEY_REQUEST_LINK_HOMEPAGE()
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        ...
        $Data = array (
            'user' => $this->config['phone'],
            'msgType' => 'GET_MONEY_REQUEST_LINK_HOMEPAGE',
            'cmdId' => (string) $microtime. '000000',
            'lang' => 'vi',
            'time' => (int) $microtime,
            'channel' => 'APP',
            ...
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_MONEY_REQUEST_LINK_HOMEPAGE', $microtime),
            ),
        );
    ...
    public function GET_CUSTOM_MONEY_REQUEST_LINKS()
    {
        $microtime = $this->get_microtime();
        $requestkeyRaw = $this->generateRandom(32);
        $requestkey = $this->RSA_Encrypt($this->config["RSA_PUBLIC_KEY"],$requestkeyRaw);
        ...
        $Data = array (
            ...
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('GET_CUSTOM_MONEY_REQUEST_LINKS', $microtime),
            ),
        );
    ...
    public function UPLOAD_IMG()
    {
        ...
        $Data = array (
            ...
            array (
              ...
              'action' => 0,
              '_class' => 'mservice.backend.entity.msg.UploadImgMsg',
            ),
            'extra' => 
            array (
              'checkSum' => $this->generateCheckSum('UPLOAD_IMG', $microtime),
            ),
        );
        return $this->CURL("UPLOAD_IMG",$header,$this->Encrypt_data($Data,$requestkeyRaw));
    }
        ...
        $Data =  array(
            ...
            array(
             ...
             array (
              ...
              'extras' => '{"appSendChat":true,"vpc_CardType":"SML","vpc_TicketNo":"'.$ipaddress.'"","vpc_PaymentGateway":""}',
           ),
            'extra' => 
            array(
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'serviceId' => 'transfer_p2p',
                  'extras' => '{"loanId":0,"appSendChat":true,"loanIds":[],"stickers":"","themeUrl":"https://cdn.mservice.com.vn/app/img/transfer/theme/Corona_750x260.png","hidePhone":false,"vpc_CardType":"SML","vpc_TicketNo":"'.$ipaddress.'","vpc_PaymentGateway":""}',
                ),
              ),
              'extras' => '{"loanId":0,"appSendChat":true,"loanIds":[],"stickers":"","themeUrl":"https://cdn.mservice.com.vn/app/img/transfer/theme/Corona_750x260.png","hidePhone":false,"vpc_CardType":"SML","vpc_TicketNo":"'.$ipaddress.'","vpc_PaymentGateway":""}',
              'moneySource' => 1,
    ...
    public function QUERY_TRAN_NEW()
    {
        ...
        return $this->CURL("APIMOMOVN_GET_TRAN",$header,$this->Encrypt_data($Data,$requestkeyRaw));
